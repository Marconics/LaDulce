...
export default async function RoutesPedidos(app) {
  ...
  //   enderecoId?: number,                 // usar um endereço já salvo, OU
  //   endereco?: { rua, numero, bairro, cidade, estado, cep }  // criar um novo na hora
  // }
  ...
  // GET /pedidos/listar
  // Lista os pedidos do usuário logado, do mais recente para o mais antigo.
  ...
  // GET /pedidos/:id
  // Detalhe de um pedido — só o dono do pedido (ou um admin) pode ver.
  ...
  // Só ADMIN pode avançar o status do pedido (painel administrativo).
